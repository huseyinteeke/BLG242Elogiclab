...
HD_PWD='C:/LogicLabProjects/Project2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log advanced_circuits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source advanced_circuits.tcl -notrace
