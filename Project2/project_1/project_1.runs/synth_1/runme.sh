...
HD_PWD='C:/LogicLabProjects/Project2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log advanced_circuits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source advanced_circuits.tcl
